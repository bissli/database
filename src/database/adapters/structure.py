...
def create_row_adapter(connection: Any, row: Any) -> 'RowStructureAdapter':
...
class RowStructureAdapter:
    ...
    @staticmethod
    def create(connection: Any, row: Any) -> 'RowStructureAdapter':
    ...
    def _get_first_value_from_dict(self, data: dict[str, Any]) -> Any:
        """Safely get the first value from a dictionary.
        """
        if not data:
            return None
...
class SQLiteRowAdapter(RowStructureAdapter):
    ...
    def get_value(self, key: str | int | None = None) -> Any:
...
class ResultStructureAdapter:
    ...
    def __init__(self, connection: Any, data: list[Any]) -> None:
    ...
    def get_first_row_dict(self) -> dict[str, Any] | None:
    ...
    def get_column_values(self, column_index: int | str = 0) -> list[Any]:
